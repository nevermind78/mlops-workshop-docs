...
2. **Azure CLI** installé et connecté (`az login`)
3. **Image locale** `bank-churn-api:v1` déjà construite
...
echo "✅ Environnement Container Apps créé : $CONTAINERAPPS_ENV"
```

### Étape 5 : Déploiement de l'Application {#sec-module4-etape5}

::: callout-important
## ⚠️ Problème connu avec les secrets ACR

La commande `az containerapp create` génère automatiquement un nom de secret invalide.
Nous utilisons une approche YAML pour contourner ce problème.
:::
...
echo "Déploiement de l'application Container App..."
...
# Supprimer toutes les ressources après le workshop
