...
3.  **Onglet "Général"** :
    ...
    -   Nom du registre : `acrmlops[VOTRE_USERNAME][TIMESTAMP]`
        *Ex: acrmlopsjean1648826400* (le nom doit être unique dans Azure et contenir de 5 à 50 caractères alphanumériques ).
>>>>>>> origin/main
...
=======
Pour ce workshop et pour optimiser les coûts :
...
**Coût estimé** : ~5-10€/mois (ACR Basic + Container App en fonctionnement)
